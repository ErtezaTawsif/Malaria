...
WEIGHTS_PATH = 'VGG - 19/vgg19_weights_tf_dim_ordering_tf_kernels.h5'
WEIGHTS_PATH_NO_TOP = 'D:\Tanvir_Thesis\VGG - 19\vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
model_checkpoint = ModelCheckpoint('Malaria_VGG_Model_by_Machine.h5', verbose=1, save_best_only=True)
...
def fit_and_evaluate(X_Train, X_Test, Y_Train, Y_Test, y_test_ROC):
    ...
    model.save('Malaria_VGG19_Model.h5')
